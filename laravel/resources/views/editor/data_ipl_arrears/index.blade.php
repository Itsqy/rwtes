...
@section('title', 'Data Tunggakan IPL')   
...
<script>
  var table;
    $(document).ready(function() {
        ...
        ajax: "{{ URL::route('editor.data-ipl-arrears.data') }}",
        columns: [
        { data: 'nip', name: 'nip' },
        { data: 'name', name: 'name' },
        { data: 'hp', name: 'hp' },
    ...
    { 
      ...
      $.ajax({
        ...
        success: function(data)
        {
          ...
          $('.modal-title').text('Edit Data Tunggakan IPL'); // Set title to Bootstrap modal title
        },
    ...
    function update(id)
    {
      ...
      $.ajax({
        ...
        success: function(data) {  
          $('.errorData Tunggakan IPLName').addClass('hidden');
          ...
          if ((data.errors)) {
            ...
            if (data.errors.house_type_name) {
              $('.errorData Tunggakan IPLName').removeClass('hidden');
              $('.errorData Tunggakan IPLName').text(data.errors.house_type_name);
            }
          } else {
          var options = { 
            "positionClass": "toast-bottom-right", 
